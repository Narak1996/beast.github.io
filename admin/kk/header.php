        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><img src="../img/logo/logo.png" width="40px" style="margin-top: -15px"></i><span class="admin_text" style="font-size:35px;"> ម៉ាម៉ា</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../img/logo/logo.jpg" alt="..." class="img-circle profile_img">
              </div>
